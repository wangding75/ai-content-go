...
- Name: iteration1-ui.spec.ts >> Iteration 1 Web Admin frontend UI roundtrip >> home dashboard renders request_id and retry action on backend error
- Location: e2e/iteration1-ui.spec.ts:74:7
...
Locator: locator('main').getByRole('alert')
Expected substring: "INTERNAL_ERROR"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('main').getByRole('alert')

```

```yaml
- navigation "Iteration 2 navigation":
  - link "首页 / 系统大盘":
    - /url: /
  - link "项目管理":
    - /url: /?view=projects
  ...
  - link "LLM Logs":
    - /url: /llm/logs
- main:
  - heading "首页 / 系统大盘" [level=1]
  - button "新建项目"
  - paragraph: 加载态
  - heading "进行中的项目" [level=2]
  - button "进入项目"
```
