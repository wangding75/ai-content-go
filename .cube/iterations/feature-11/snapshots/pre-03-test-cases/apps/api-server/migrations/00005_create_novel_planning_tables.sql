...
CREATE UNIQUE INDEX IF NOT EXISTS idx_planning_run_project_idempotency_key ON planning_run(project_id, idempotency_key) WHERE idempotency_key IS NOT NULL;
