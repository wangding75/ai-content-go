...
const navItems = [
  ...
  { href: '/platform-adapters', label: '平台 Adapter', match: (pathname: string) => pathname === '/platform-adapters' },
  { href: '/plugin-clients', label: '插件客户端', match: (pathname: string) => pathname === '/plugin-clients' },
